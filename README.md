[Goodhart's Law](https://wikipedia.org/wiki/Goodhart's_law) summarizes the state of modern upper-level education pretty well:
...
The developer vigorously defends the right to create and distribute interoperable software.
We will file a counter-notice pursuant to 17 U.S.C. § 512(g)(3) in response to **any and all** invalid DMCA takedown requests received.
Any party considering filing a takedown notice is advised to consult with legal counsel regarding the protections afforded to fair use and interoperability before proceeding.
We reserve the right to seek damages, including costs and attorneys’ fees, under 17 U.S.C. § 512(f) for any material misrepresentation in a notification that the material or activity is infringing.
